...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.flutter_background_messenger.FlutterBackgroundMessengerPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_background_messenger, com.example.flutter_background_messenger.FlutterBackgroundMessengerPlugin", e);
    }
    try {
